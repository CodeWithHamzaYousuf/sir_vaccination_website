...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  // Get the form data
  $hospitalName = mysqli_real_escape_string($conn, $_POST['hospital-name']);
  $hospitalEmail = mysqli_real_escape_string($conn, $_POST['hospital-email']);
  $hospitalAddress = mysqli_real_escape_string($conn, $_POST['hospital-address']);
  $hospitalContact = mysqli_real_escape_string($conn, $_POST['hospital-contact']);
  $zipCode = mysqli_real_escape_string($conn, $_POST['zip']);


  // Insert the data into the database
  $sql = "INSERT INTO `listofhospital`(name,email,address,zip_code,contact) VALUES('$hospitalName', '$hospitalEmail', '$hospitalAddress', '$zipCode', '$hospitalContact')";
      ...
      <!-- <form action="#">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="doctors.php">Hospitals</a>
            </li>
            <!-- <li class="nav-item">
...
<p class="thank-you"> Thank you for registering, <?php echo $_POST["hospital-name"];?></p>

<p class="details">
    <p class="details"><b>Hospital's Name:</b> <?php echo $_POST["hospital-name"]?></p>
    <p class="details"><b>Hospital's Email Address:</b> <?php echo $_POST["hospital-email"]?></p>
    <p class="details"><b>Location:</b> <?php echo $_POST["hospital-address"]?></p>
    <p class="details"><b>ZIP Code:</b> <?php echo $_POST["zip"]?></p>
    <p class="details"><b>Hospital's No:</b> <?php echo $_POST["hospital-contact"]?></p>
</p>
</div>
